            ...
            try:
                ...
                if _trader:
                    ...
                    try:
                        ...
                        _p7081_val = sum(_qty7 * _price_map.get(_sym7, 0) for _sym7, _qty7 in _p7081_live)
                        _eur_invested = round(sum(_qty7 * _price_map.get(_sym7, 0) / _eur_usdt for _sym7, _qty7 in _p7081_live), 2)
                        _db7081.close()
                    except Exception:
                    ...
                    _eur_free_usdt = _eur_free * _eur_usdt
                    _usdc_portfolio = round(_total_usdt - _eur_free_usdt, 2)
                    _usdc_inv_total = round(_usdc_portfolio - _usdc, 2) if _usdc_portfolio > 0 else 0
                    _usdc_available = round(_usdc, 2)
            except Exception:
