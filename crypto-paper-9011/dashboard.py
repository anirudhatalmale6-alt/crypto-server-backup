    ...
    <div class="container">
        ...
        <div class="settings-panel" style="border-color:#238636;margin-bottom:16px">
            ...
            <div class="settings-grid" style="grid-template-columns:repeat(6,1fr)">
                ...
                <div><label>Pump Window</label><div style="padding:8px 12px;background:#0d1117;border:1px solid #30363d;border-radius:6px;color:#58a6ff;font-weight:600">{{ pump_window }}s</div></div>
                <div><label>Take Profit</label><div style="padding:8px 12px;background:#0d1117;border:1px solid #30363d;border-radius:6px;color:#3fb950;font-weight:600">{{ pump_tp }}%</div></div>
                <div><label>Stop Loss</label><div style="padding:8px 12px;background:#0d1117;border:1px solid #30363d;border-radius:6px;color:#f85149;font-weight:600">{{ pump_sl }}%</div></div>
            </div>
            <div class="settings-grid" style="grid-template-columns:repeat(4,1fr);margin-top:8px">
                <div><label>Max Duration</label><div style="padding:8px 12px;background:#0d1117;border:1px solid #30363d;border-radius:6px;color:#f0f6fc;font-weight:600">{{ max_duration }} hours</div></div>
                <div><label>Trade Amount</label><div style="padding:8px 12px;background:#0d1117;border:1px solid #30363d;border-radius:6px;color:#f0f6fc;font-weight:600" id="scalpAmount">{{ amount }} USDC</div></div>
                <div><label>Max Positions</label><div style="padding:8px 12px;background:#0d1117;border:1px solid #30363d;border-radius:6px;color:#f0f6fc;font-weight:600">{{ max_trades }}</div></div>
...
_COND_FILE = "/opt/crypto-paper-9011/cond_close.json"
